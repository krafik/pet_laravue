...
{{--    <link rel="stylesheet" href="{{public_path().'plugins/colorbox/colorbox.css'}}">--}}
    <!-- Template styles-->
                                ...
                                <ul class="nav navbar-nav mr-auto">
                                    <li class="nav-item dropdown active">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li><a href="/main-sec">Home Two</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li><a href="/service-single">Services Single</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="nav-item dropdown">
                                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">News <i
                                                class="fa fa-angle-down"></i></a>
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="/news-left-sidebar">News Left Sidebar</a></li>
                                            <li><a href="/news-right-sidebar">News Right Sidebar</a></li>
                                            <li><a href="/news-single">News Single</a></li>
                                        </ul>
                                    </li>
